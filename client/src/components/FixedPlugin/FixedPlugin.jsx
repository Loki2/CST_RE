      ...
      <div className="fixed-plugin">
        <div className={this.state.classes}>
          ...
          <ul className="dropdown-menu show">
            <li className="header-title">ສີພື່ນຫລິງ SIDEBAR</li>
            ...
            <li className="header-title">ຫຍໍ້ຂະຫນາດ SIDEBAR</li>
            <li className="adjustments-line">
              <div className="togglebutton switch-sidebar-mini">
                <span className="label-switch">ປິດ</span>
                <Switch
                  ...
                  offText=""
                />
                <span className="label-switch">ເປີດ</span>
              </div>
            </li>
            <li className="adjustments-line">
              <div className="togglebutton switch-change-color mt-3">
                <span className="label-switch">ໂມດແຈ້ງ</span>
                <Switch
                  ...
                  offText=""
                />
                <span className="label-switch">ໂມດມຶດ</span>
              </div>
            </li>
          </ul>
        </div>
